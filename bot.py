...
def update_profit(username):
    ...
    capital = float(user_deposits.get(username, 0))
    if capital <= 0:
        return
    ...
    if days_passed > 0:
        daily_profit = capital * 0.02
        total_profit = round(daily_profit * days_passed, 2)
